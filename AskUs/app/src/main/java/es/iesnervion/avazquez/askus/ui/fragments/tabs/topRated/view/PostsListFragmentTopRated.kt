 ...
 */
class PostsListFragmentTopRated : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    lateinit var viewModel: MainViewModelTopRated
    ...
    companion object {
        fun newInstance(idTag: Int): PostsListFragmentTopRated {
            val myFragment = PostsListFragmentTopRated()
            val args = Bundle()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(MainViewModelTopRated::class.java)
        sharedPreference =
    ...
    private fun initObservers() {
        ...
        viewModel.areValuesReadyTopRated().observe(viewLifecycleOwner, Observer(::onValuesReady))
    }
