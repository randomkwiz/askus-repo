...
class UserMapper() : Mapper<UserDTO, User>() {
    override fun dtoToModel(dto: UserDTO): User {
        return User(dto.id, dto.nickname, dto.email ?: "", dto.isModerador ?: false,
            dto.isBanned ?: false, dto.fechaInicioBaneo ?: "", dto.duracionBaneoEnDias ?: 0,
            dto.fechaCreacionCuenta ?: "", dto.fechaUltimoAcceso ?: "", dto.isAdmin ?: false,
            password = "")
    }
